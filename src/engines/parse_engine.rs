...
pub fn parse_engine(name: &str) -> Result<Box<dyn Engine>> {
	Ok(match name {
		...
		"a1.mat" => Box::new(AlphaBeta::new(material, 1)),
		"a2.mat" => Box::new(AlphaBeta::new(material, 2)),
		"a3.mat" => Box::new(AlphaBeta::new(material, 3)),
		"a4.mat" => Box::new(AlphaBeta::new(material, 4)),
